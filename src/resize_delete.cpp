...
void resize_class::del_carray(char *&field,int numi)
{
	if(numi>0)
    delete [ ] field;
}
...
void resize_class::del_carray(char **&field,int numi, int numj)
{
	int i;
...
void resize_class::del_carray(char ***&field,int numi, int numj, int numk)
{
	int i,j;
