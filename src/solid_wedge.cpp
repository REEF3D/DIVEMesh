...
void solid::wedge(lexer *p, dive *a, int rank, int &ts, int &te)
{
    ...
    x4 = p->S82_xyz[rank][9];
    y4 = p->S82_xyz[rank][10];
    z4 = p->S82_xyz[rank][11];
	
	x5 = p->S82_xyz[rank][12];
    y5 = p->S82_xyz[rank][13];
    z5 = p->S82_xyz[rank][14];
	
	x6 = p->S82_xyz[rank][15];
    y6 = p->S82_xyz[rank][16];
    z6 = p->S82_xyz[rank][17];
