...
void geometry::arch(lexer* p, dive* a, int rank, int &ts, int &te, double xs,double xe,double ys,double ye,double zs,double ze,double r)
{	
	ts=p->tricount;
	
	double ym,Um,dy,dz,ds,phi,ycorr,zcorr;
    int Nr,N3,Ndiff;
    int N3_1,N3_2,N3_3;
