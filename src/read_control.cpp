        ...
        switch(c)
        {
            ...
            control>>numint;
                ...
                case 10: control>>S10_xs[countS10]>>S10_xe[countS10]>>S10_ys[countS10]>>S10_ye[countS10]>>S10_zs[countS10]>>S10_ze[countS10];
                         S10_xs[countS10] = Xin(S10_xs[countS10],S10_ys[countS10]);
                         S10_xe[countS10] = Xin(S10_xe[countS10],S10_ye[countS10]);
                         S10_ys[countS10] = Yin(S10_xs[countS10],S10_ys[countS10]);
                         S10_ye[countS10] = Yin(S10_xe[countS10],S10_ye[countS10]);
                         ++countS10;
                         clear(c,numint);
                         break;
                case 11: control>>S11_xs[countS11]>>S11_ys[countS11]>>S11_zs[countS11]>>S11_L[countS11]>>S11_G[countS11]>>S11_ni[countS11]>>S11_nj[countS11]>>S11_nk[countS11];
                         S11_xs[countS11] = Xin(S11_xs[countS11],S11_ys[countS11]);
                         S11_ys[countS11] = Yin(S11_xs[countS11],S11_ys[countS11]);
                         ++countS11;
                         clear(c,numint);
                         break;
                case 12: control>>S12_xs[countS12]>>S12_ys[countS12]>>S12_zs[countS12]>>S12_xe[countS12]>>S12_ye[countS12]>>S12_ze[countS12]>>S12_b[countS12]>>S12_h[countS12];
                         S12_xs[countS12] = Xin(S12_xs[countS12],S12_ys[countS12]);
                         S12_ys[countS12] = Yin(S12_xs[countS12],S12_ys[countS12]);
                         ++countS12;
                         clear(c,numint);
                         break;
                case 32: control>>S32_xm[countS32]>>S32_zm[countS32]>>S32_r[countS32];
                         S32_xm[countS32] = Xin(S32_xm[countS32],0.0);
                         ++countS32;
                         clear(c,numint);
                         break;
                case 33: control>>S33_xm[countS33]>>S33_ym[countS33]>>S33_r[countS33];
                         S33_xm[countS33] = Xin(S33_xm[countS33],S33_ym[countS33]);
                         S33_ym[countS33] = Yin(S33_xm[countS33],S33_ym[countS33]);
                         ++countS33;
                         clear(c,numint);
                         break;
                case 37: control>>S37_xm1[countS37]>>S37_ym1[countS37]>>S37_zm1[countS37]>>S37_r1[countS37]>>S37_xm2[countS37]>>S37_ym2[countS37]>>S37_zm2[countS37]>>S37_r2[countS37];
                         S37_xm1[countS37] = Xin(S37_xm1[countS37],S37_ym1[countS37]);
                         S37_ym1[countS37] = Yin(S37_xm1[countS37],S37_ym1[countS37]);
                         S37_xm2[countS37] = Xin(S37_xm2[countS37],S37_ym2[countS37]);
                         S37_ym2[countS37] = Yin(S37_xm2[countS37],S37_ym2[countS37]);
                         ++countS37;
                         clear(c,numint);
                         break;
                ...
                case 42: control>>S42_xm[countS42]>>S42_zm[countS42]>>S42_y1[countS42]>>S42_y2[countS42]>>S42_r1[countS42]>>S42_r2[countS42];
                         S42_xm[countS42] = Xin(S42_xm[countS42],0.0);
                         ++countS42;
                         clear(c,numint);
                         break;
                case 43: control>>S43_xm[countS43]>>S43_ym[countS43]>>S43_z1[countS43]>>S43_z2[countS43]>>S43_r1[countS43]>>S43_r2[countS43];
                         S43_xm[countS43] = Xin(S43_xm[countS43],S43_ym[countS43]);
                         S43_ym[countS43] = Yin(S43_xm[countS43],S43_ym[countS43]);
                         ++countS43;
                         clear(c,numint);
                         break;
                case 51: control>>S51_xm[countS51]>>S51_ym[countS51]>>S51_zm[countS51]>>S51_r[countS51];
                         S51_xm[countS51] = Xin(S51_xm[countS51],S51_ym[countS51]);
                         S51_ym[countS51] = Yin(S51_xm[countS51],S51_ym[countS51]);
                         ++countS51;
                         clear(c,numint);
                         break;
                case 52: control>>S52_xm[countS52]>>S52_ym[countS52]>>S52_zm[countS52]>>S52_a[countS52]>>S52_b[countS52]>>S52_c[countS52];
                         S52_xm[countS52] = Xin(S52_xm[countS52],S52_ym[countS52]);
                         S52_ym[countS52] = Yin(S52_xm[countS52],S52_ym[countS52]);
                         ++countS52;
                         clear(c,numint);
                         break;
                case 53: control>>S53_xm[countS53]>>S53_ym[countS53]>>S53_zm[countS53]>>S53_a[countS53]>>S53_b[countS53]>>S53_c[countS53]>>S53_h[countS53];
                         S53_xm[countS53] = Xin(S53_xm[countS53],S53_ym[countS53]);
                         S53_ym[countS53] = Yin(S53_xm[countS53],S53_ym[countS53]);
                         ++countS53;
                         clear(c,numint);
                         break;
                case 54: control>>S54_xm[countS54]>>S54_ym[countS54]>>S54_zm[countS54]>>S54_a[countS54]>>S54_b[countS54]>>S54_c[countS54]>>S54_h[countS54]>>S54_phi[countS54]>>S54_theta[countS54]>>S54_psi[countS54];
                         S54_xm[countS54] = Xin(S54_xm[countS54],S54_ym[countS54]);
                         S54_ym[countS54] = Yin(S54_xm[countS54],S54_ym[countS54]);
                         ++countS54;
                         clear(c,numint);
                         break;
                case 61: control>>S61_xs[countS61]>>S61_xe[countS61]>>S61_ys[countS61]>>S61_ye[countS61]>>S61_zs[countS61]>>S61_ze[countS61];
                         S61_xs[countS61] = Xin(S61_xs[countS61],S61_ys[countS61]);
                         S61_xe[countS61] = Xin(S61_xe[countS61],S61_ye[countS61]);
                         S61_ys[countS61] = Yin(S61_xs[countS61],S61_ys[countS61]);
                         S61_ye[countS61] = Yin(S61_xe[countS61],S61_ye[countS61]);
                         ++countS61;
                         clear(c,numint);
                         break;
                case 62: control>>S62_xs[countS62]>>S62_xe[countS62]>>S62_ys[countS62]>>S62_ye[countS62]>>S62_zs[countS62]>>S62_ze[countS62];
                         S62_xs[countS62] = Xin(S62_xs[countS62],S62_ys[countS62]);
                         S62_xe[countS62] = Xin(S62_xe[countS62],S62_ye[countS62]);
                         S62_ys[countS62] = Yin(S62_xs[countS62],S62_ys[countS62]);
                         S62_ye[countS62] = Yin(S62_xe[countS62],S62_ye[countS62]);
                         ++countS62;
                         clear(c,numint);
                         break;
                case 63: control>>S63_xs[countS63]>>S63_xe[countS63]>>S63_ys[countS63]>>S63_ye[countS63]>>S63_zs[countS63]>>S63_ze[countS63];
                         S63_xs[countS63] = Xin(S63_xs[countS63],S63_ys[countS63]);
                         S63_xe[countS63] = Xin(S63_xe[countS63],S63_ye[countS63]);
                         S63_ys[countS63] = Yin(S63_xs[countS63],S63_ys[countS63]);
                         S63_ye[countS63] = Yin(S63_xe[countS63],S63_ye[countS63]);
                         ++countS63;
                         clear(c,numint);
                         break;
                ...
                case 121: control>>S121_x[countS121]>>S121_y[countS121]>>S121_z[countS121]>>S121_b[countS121]>>S121_Pd[countS121]>>S121_H0[countS121];
                         S121_x[countS121] = Xin(S121_x[countS121],S121_y[countS121]);
                         S121_y[countS121] = Yin(S121_x[countS121],S121_y[countS121]);
                         ++countS121;
                         clear(c,numint);
                         break;
                case 122: control>>S122_K[countS122]>>S122_n[countS122]>>S122_xc[countS122]>>S122_yc[countS122];
                         S122_xc[countS122] = Xin(S122_xc[countS122],S122_yc[countS122]);
                         S122_yc[countS122] = Yin(S122_xc[countS122],S122_yc[countS122]);
                         ++countS122;
                         clear(c,numint);
                         break;
                ...
                case 131: control>>S131_xm[countS131]>>S131_zm[countS131]>>S131_y1[countS131]>>S131_y2[countS131]>>S131_r1[countS131]>>S131_r2[countS131];
                         S131_xm[countS122] = Xin(S131_xm[countS131],S131_y1[countS131]);
                         S131_y1[countS122] = Xin(S131_xm[countS131],S131_y1[countS131]);
                         S131_y2[countS122] = Xin(S131_xm[countS131],S131_y2[countS131]);
                         ++countS131;
                         clear(c,numint);
                         break;
                case 141: control>>S141_xs[countS141]>>S141_xe[countS141]>>S141_ys[countS141]>>S141_ye[countS141]>>S141_zs[countS141]>>S141_ze[countS141]>>S141_r[countS141];
                         S141_xs[countS141] = Xin(S141_xs[countS141],S141_ys[countS141]);
                         S141_xe[countS141] = Xin(S141_xe[countS141],S141_ye[countS141]);
                         S141_ys[countS141] = Yin(S141_xs[countS141],S141_ys[countS141]);
                         S141_ye[countS141] = Yin(S141_xe[countS141],S141_ye[countS141]);
                         ++countS141;
                         clear(c,numint);
                         break;
