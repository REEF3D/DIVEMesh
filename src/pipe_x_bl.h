...
class pipe_x_bl : public entity, public increment
{
public:
    pipe_x_bl(lexer*,int,int);
    virtual ~pipe_x_bl();
...
private:
    ...
    double root;
    int nb1,nb2;
    int pipe_x_bl_type,pipe_x_bl_side,pipe_x_bl_rank;
    int pipe_x_bl_xdir, pipe_x_bl_ydir, pipe_x_bl_zdir;
