...
class pipe_y_bl : public entity, public increment
{
public:
    pipe_y_bl(lexer*,int,int);
    virtual ~pipe_y_bl();
...
private:
    ...
    double root;
    int nb1,nb2;
    int pipe_y_bl_type,pipe_y_bl_side,pipe_y_bl_rank;
    int pipe_y_bl_xdir, pipe_y_bl_ydir, pipe_y_bl_zdir;
