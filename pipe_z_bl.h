...
class pipe_z_bl : public entity, public increment
{
public:
    pipe_z_bl(lexer*,int,int);
    virtual ~pipe_z_bl();
...
private:
    ...
    double root;
    int nb1,nb2;
    int pipe_z_bl_type,pipe_z_bl_side,pipe_z_bl_rank;
    int pipe_z_bl_xdir, pipe_z_bl_ydir, pipe_z_bl_zdir;
